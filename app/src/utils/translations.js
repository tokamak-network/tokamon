...
export const translations = {
  ko: {
    ...
    walletLinkWarning: '주소 등록을 하지 않고 앱을 삭제하실 경우, TON을 출금할 수 없습니다. 지갑 메뉴에서 꼭 주소 등록을 해주세요.',
    walletWarningTitle: '지갑 등록 안내',
    walletWarningBody: '앱을 삭제하면 적립된 TON을\n출금할 수 없습니다.',
    walletWarningAction: '지갑 메뉴에서 주소를 등록하세요',
    claimFailed: '클레임 실패',
  ...
  en: {
    ...
    walletLinkWarning: 'If you delete the app without registering a wallet address, you will not be able to withdraw your TON. Please register your address in the Wallet menu.',
    walletWarningTitle: 'Register Your Wallet',
    walletWarningBody: 'If you delete the app, you will lose\naccess to your earned TON.',
    walletWarningAction: 'Register your address in the Wallet menu',
