    ...
    return (
      <div key={spot.id} className="owner-spot-card">
              <div className="spot-list-item-header">
                ...
                <span
                  className={`spot-list-item-status ${isExhausted ? 'exhausted' : isSpotClosed(spot) ? 'closed' : isWithinActiveTime(spot) ? 'active' : 'inactive'}`}
                >
              ...
              <div className="spot-list-item-detail">
                ...
                {' | '}{t(language, 'cooldown')} {cooldownDisplay}
              </div>
              <div className="spot-list-item-detail">
